...
// An abstract icon representing a neural node or a spark of intelligence.
export const NeuralSparkIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 8.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7ZM12 1.5 16.5 6l-1.5 1.5-3-3-3 3L7.5 6 12 1.5ZM1.5 12 6 7.5l1.5 1.5-3 3 3 3-1.5 1.5L1.5 12Zm10.5 10.5L7.5 18l1.5-1.5 3 3 3-3 1.5 1.5-4.5 4.5ZM22.5 12l-4.5 4.5-1.5-1.5 3-3-3-3 1.5-1.5 4.5 4.5Z"/>
    </svg>
);
...
export const WandIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M15 4V2m0 14v-2m-7.5-13L6 4.5M6 19.5 4.5 18m12.7-12.7L18 6.5M18 19.5l-1.5-1.5M4 9H2m14 0h-2m-4.5 7.5L6 18m12.7-5.2-1.5-1.5M4 15h2m14 0h-2"></path>
        <path d="M9 15a6 6 0 0 1-6-6 6 6 0 0 1 6-6 6 6 0 0 1 6 6 6 6 0 0 1-6 6Z"></path>
    </svg>
);
...
export const LightbulbIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M15 14c.2-1 .7-1.7 1.5-2.5C17.7 10.2 18 9 18 8c0-2.2-1.8-4-4-4-2.2 0-4 1.8-4 4 0 1 .3 1.8 1 2.5.8.8 1.3 1.5 1.5 2.5"></path>
...
export const Volume2Icon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
